...
/**
 * Multi-format request presets. Return plain `MultiFormatAdRequestOptions`;
 * `MultiFormatAdRequest.create` / `useMultiFormatAd` take the ad unit
 * separately because request options do not carry it.
 */

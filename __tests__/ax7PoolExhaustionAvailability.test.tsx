...
/**
 * AX-7: exhaustion / refresh observability and availability surface.
 * Runtime still stubs; locks public shapes + docs vocabulary.
 *
 * Findings: EXP-F8, EXP-F9, EXP-F13, EXP-F10 (residue → AX-0I onStaleByPolicy),
 * IDM-A12, IDM-C7.
 */
...
/** Docs / JSDoc vocabulary locks (EXP-F8/F9/F13, IDM-A12/C7). */
...
describe('AX-7 pool exhaustion and availability surface', () => {
